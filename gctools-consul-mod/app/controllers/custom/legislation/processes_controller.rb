class Legislation::ProcessesController < Legislation::BaseController
  ...
  def debate
    ...
    if @process.debate_phase.started? || (current_user && (current_user.administrator? || current_user.test?))
      render :debate
    else
  ...
  def proposals
    ...
    if @process.proposals_phase.started? || (current_user && (current_user.administrator? || current_user.test?))
